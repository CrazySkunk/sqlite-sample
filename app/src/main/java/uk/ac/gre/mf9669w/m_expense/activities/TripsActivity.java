...
public class TripsActivity extends AppCompatActivity {
    ...
    private void populateRecycler(List<Trip> trips) {
        ...
        adapter.setOnItemLongClickListener(position -> {
            PopupMenu popupMenu = new PopupMenu(TripsActivity.this, binding.tripsRecycler, Gravity.CENTER);
            ...
            popupMenu.setOnMenuItemClickListener(item -> {
                if (item.getTitle().equals("Edit")) {
                    ...
                    expenseDialogBinding.button.setOnClickListener(v -> {
                        ...
                        Expense expense = new Expense(trips.get(position).getId(),typeOfExpense, amountOfExpense, timeOfExpense);
